...
#include <unistd.h>
#include <sqlite3.h>
// esp_spi_flash.h was removed/renamed upstream (ESP-IDF migration,
// PLANO_ESPIDF_DONGLE.md phase 5) -- SPI_FLASH_SEC_SIZE was its only symbol
// this file actually used (esp32_SectorSize(), just reporting a VFS I/O
// alignment hint to sqlite3), and 4096 is that same standard flash sector
// size, not a value specific to the removed header.
